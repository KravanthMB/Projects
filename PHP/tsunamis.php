...
<body>
    ...
    <div id="tsunamis" class="section">
        <h1>Tsunamis</h1>
        <p>A tsunami, from Japanese: 津波,'harbour wave' pronounced [tsɯnami] is a series of waves in a water body caused by the displacement of a large volume of water, generally in an ocean or a large lake. Earthquakes, volcanic eruptions and other underwater explosions (including detonations, landslides, glacier calvings, meteorite impacts and other disturbances) above or below water all have the potential to generate a tsunami.</p>
    </div><img src="tsunamis.gif" alt="tsunamis" class="center">
