...
<body>
    ...
    <div class="container">
        <div id="landslides" class="section">
            <h1>Landslides</h1>
            <p>Landslides, also known as landslips,are several forms of mass wasting that may include a wide range of ground movements, such as rockfalls, mudflows, shallow or deep-seated slope failures and debris flows Landslides occur in a variety of environments, characterized by either steep or gentle slope gradients, from mountain ranges to coastal cliffs or even underwater,in which case they are called submarine landslides.</p>
        </div><img src="landslides.gif" alt="landslides" class="center">
