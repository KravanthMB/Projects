...
<body>
    ...
    <div class="container">
        <div id="avalanches" class="section">
            <h1>Avalanches</h1>
            <p>An avalanche is a rapid flow of snow down a slope, such as a hill or mountain. Avalanches can be triggered spontaneously, by factors such as increased precipitation or snowpack weakening, or by external means such as humans, other animals, and earthquakes.</p>
            <img src="avalanches.gif" alt="Avalanches" class="center">
        </div>
