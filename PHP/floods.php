...
<body>
    ...
    <div class="container">
        <div id="floods" class="section">
            <h1>Floods</h1>
            <p>A flood is an overflow of water (or rarely other fluids) that submerges land that is usually dry. In the sense of "flowing water", the word may also be applied to the inflow of the tide. Floods are of significant concern in agriculture, civil engineering and public health. Human changes to the environment often increase the intensity and frequency of flooding.</p>
        <img src="floods.gif" alt="floods" class="center">
    </div>
