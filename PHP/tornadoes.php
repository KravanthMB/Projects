...
<body>
    ...
    <div id="tornadoes" class="section">
        <h1>Tornadoes</h1>
        <p>A tornado is a rapidly rotating column of air that is in contact with both the surface of the Earth and a cumulonimbus cloud or, in rare cases, the base of a cumulus cloud. The wind speeds of tornadoes can vary from less than 110 mph to over 300 mph, causing varying degrees of damage along their paths.</p>
    </div><img src="tornadoes.gif" alt="tornadoes" class="center">
