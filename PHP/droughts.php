...
<body>
    ...
    <div class="container">
        <div id="droughts" class="section">
            <h1>Droughts</h1>
            <p>A drought is a period of drier-than-normal conditions. A drought can last for days, months or years. Drought often has large impacts on the ecosystems and agriculture of affected regions, and causes harm to the local economy. Annual dry seasons in the tropics significantly increase the chances of a drought developing, with subsequent increased wildfire risks.</p>
        <img src="droughts.gif" alt="droughts" class="center">
        </div>
