...
<body>
    ...
    <div class="container">
        <div id="blizzards" class="section">
            <h1>Blizzards</h1>
            <p>A blizzard is a severe snowstorm characterized by strong sustained winds of at least 35 mph and lasting for a prolonged period of time—typically three hours or more. It can result in whiteout conditions and significant snowdrifts.</p>
        <img src="blizzards.gif" alt="blizzards" class="center">
        </div>
