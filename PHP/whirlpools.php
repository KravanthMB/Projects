...
<body>
    ...
    <div id="whirlpools" class="section">
        <h1>Whirlpools</h1>
        <p>A whirlpool is a body of rotating water produced by opposing currents or a current running into an obstacle. Small whirlpools form when a bath or a sink is draining. More powerful ones formed in seas or oceans may be called maelstroms</p>
    </div><img src="whirlpools.gif" alt="whirlpools" class="center">
