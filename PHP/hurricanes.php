...
<body>
    ...
    <div class="container">
        <div id="hurricanes" class="section">
            <h1>Hurricanes</h1>
            <p>A tropical cyclone is a rapidly rotating storm system with a low-pressure center, a closed low-level atmospheric circulation, strong winds, and a spiral arrangement of thunderstorms that produce heavy rain and squalls. Depending on its location and strength, a tropical cyclone is called a hurricane, typhoon, tropical storm, cyclonic storm, tropical depression, or simply cyclone</p>
        </div><img src="hurricanes.gif" alt="hurricanes" class="center">
